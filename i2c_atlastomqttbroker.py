...
# MQTT Configuration
MQTT_BROKER = "our_mqtt-broker_external_ipaddress"
MQTT_PORT = 1883
# temporary topic name, will be more structured later, this is just an intial version for testing
MQTT_TOPIC = "sensor/ph"

# Initialize MQTT Client
client = mqtt.Client()
# is the default port for non-encrypted MQTT communication.
# keepalive
